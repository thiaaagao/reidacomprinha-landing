<template>
  <div id="app" class="bg-surface">
    ...
    <section class="py-20 px-5 text-center cta-bg">
      <div class="reveal-4">
        ...
        <div class="flex gap-3 justify-center flex-wrap mb-6">
          ...
          <a href="https://chat.whatsapp.com/HslpRDIsMQY3b9Nzm1cRjh" target="_blank" rel="noopener" class="btn btn-wpp">
    ...
    <div class="cta-sticky">
      <a href="https://t.me/MelPromoNandoBot" target="_blank" rel="noopener" class="btn btn-telegram flex-1 text-center justify-center">ENTRAR NO TELEGRAM</a>
    </div>
  </div>
</template>
